...
from graphsage.demo3.graphsage.inits import zeros
from graphsage.demo3.graphsage.layers import Layer
...
class BipartiteEdgePredLayer(Layer):
    def __init__(self, input_dim1, input_dim2, placeholders, dropout=False, act=tf.nn.sigmoid,
        ...
        with tf.variable_scope(self.name + '_vars'):
            # bilinear form
            if bilinear_weights:
                # self.vars['weights'] = glorot([input_dim1, input_dim2], name='pred_weights')
