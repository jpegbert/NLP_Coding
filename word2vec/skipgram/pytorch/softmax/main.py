import argparse
from word2vec.skipgram.pytorch.softmax import const
import numpy as np
import torch
import torch.optim as optim
import torch.nn.functional as F
from word2vec.skipgram.pytorch.softmax.dataset import Corpus, load_data
from word2vec.skipgram.pytorch.softmax.skipgram import Skipgram
from word2vec.skipgram.pytorch.softmax.utils import Utils

"""
采用pytorch以skipgram + softmax的方式实现word2vec
"""
