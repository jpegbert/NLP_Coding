...
import numpy as np
from graphsage.demo3.graphsage.models import SampleAndAggregate, SAGEInfo, Node2VecModel
from graphsage.demo3.graphsage.minibatch import EdgeMinibatchIterator
